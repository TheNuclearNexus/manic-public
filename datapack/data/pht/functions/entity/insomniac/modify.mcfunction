...
execute if predicate pht:chance/coinflip run function pht:entity/insomniac/trades/buy/spectre_gelatin
execute if predicate pht:chance/coinflip run function pht:entity/insomniac/trades/buy/pumpkin_pop
execute if predicate pht:chance/coinflip run function pht:entity/insomniac/trades/buy/spectral_arrow
...
execute if predicate pht:chance/insomniac/chances_rotten run function pht:entity/insomniac/trades/sell/vacuole
