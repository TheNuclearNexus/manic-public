summon wandering_trader ~ ~ ~ {HandDropChances:[-327.670F,-327.670F],CustomName:'{"translate":"pht.entity.zombee"}',DeathTime:19s,Silent:1b,DespawnDelay:0,Tags:["pht.entity","pht.zombee","global.ignore"],ArmorDropChances:[-327.670F,-327.670F,-327.670F,-327.670F],Offers:{},ActiveEffects:[{Id:14b,Amplifier:0b,Duration:1000000,ShowParticles:0b}],Health:20f,Attributes:[{Name:generic.max_health,Base:20}]}
