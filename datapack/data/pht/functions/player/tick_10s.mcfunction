...
execute if score @s pht.sanity matches ..2222 unless score #pht.display pht.dummy3 matches 1 unless score @s pht.dummy3 matches 2 unless score @s pht.dummy3 matches 3 run playsound pht:pht.ambience.echo ambient @s ~ ~ ~ 100 0
