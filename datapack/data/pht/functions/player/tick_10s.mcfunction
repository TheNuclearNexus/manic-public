...
execute unless entity @s[tag=pht.dummy_spawn] if predicate pht:chance/trader_spawn unless entity @e[tag=pht.insomniac,distance=..30] if score @s pht.sanity matches ..2222 run function pht:player/spawning/insomniac
