...
execute if predicate pht:chance/bulk_spawn unless score @s pht.entitycount matches 3.. unless entity @s[gamemode=spectator] unless entity @s[gamemode=creative] unless score @s pht.safe_time matches 1.. run function pht:player/spawn_init
