...
execute unless entity @s[nbt={SelectedItem:{id:"minecraft:glass_bottle",Count:1b}}] unless entity @s[gamemode=creative] run function pht:item/corpsegourd_sap/bottle_stack
