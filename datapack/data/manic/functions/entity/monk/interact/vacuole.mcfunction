advancement revoke @s only manic:technical/monk/vacuole
...
execute as @e[tag=manic.target,sort=nearest,limit=1] unless score @s manic.default3 matches 1.. run function manic:entity/monk/receive/vacuole
