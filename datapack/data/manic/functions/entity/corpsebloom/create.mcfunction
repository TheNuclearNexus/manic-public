...
execute if entity @s[tag=manic.fertilised] as @e[tag=manic.corpsebloom,sort=nearest,limit=1] run function manic:entity/corpsebloom/age/adult
tag @s remove manic.fertilised
tag @e[tag=manic.corpsebloom,sort=nearest,limit=1] remove manic.new_block
